...
Original file is located at
    https://colab.research.google.com/drive/12kWPaj1iJSX88V6xxjdJ3IAPk4EohQUX
"""
...
import pandas
iris=pandas.read_csv('/content/iris_synthetic_data.csv')
print(iris)

import pandas as pd
iris=pd.read_csv('/content/iris_synthetic_data.csv')
print(iris.head())

import pandas as pd
df=pd.DataFrame(pd.read_csv("/content/iris_synthetic_data.csv"))
df.hist()
